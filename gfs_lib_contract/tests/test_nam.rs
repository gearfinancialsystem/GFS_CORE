...
#[test]
fn test_nam_contract_creation() {
    // Créez une instance de NAM avec des paramètres de test

    let pathx = "tests/test_sets/actus-tests-nam-converted.json";
