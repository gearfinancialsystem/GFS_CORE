...
#[test]
fn test_lam_contract_creation() {
    // Créez une instance de LAN avec des paramètres de test

    let pathx = "tests/test_sets/actus-tests-lam-converted.json";
