...
JSON_FILE_PATH_APPLICABILITY = os.path.join(app.root_path, '.', 'data', 'actus-dictionary-applicability.json')
...
def load_json_data_taxonomy():
    ...
    try:
        with open(JSON_FILE_PATH_APPLICABILITY, 'r') as f:
            contracts_data = json.load(f)
    except FileNotFoundError:
        print(f"Erreur : Fichier {JSON_FILE_PATH_APPLICABILITY} introuvable.")
        contracts_data = {"applicability": {}}
    except json.JSONDecodeError:
        print(f"Erreur : Fichier {JSON_FILE_PATH_APPLICABILITY} n'est pas un JSON valide.")
        contracts_data = {"applicability": {}}
