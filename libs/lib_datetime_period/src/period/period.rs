...
use chrono::{Datelike, IsoWeek, NaiveDate, Duration, Weekday, NaiveDateTime};
use regex::Regex;
use std::fmt;
...
impl IsoPeriod {
    ...
    pub fn to_iso_datetime(&self, reference: NaiveDateTime) -> Option<IsoDateTime> {
