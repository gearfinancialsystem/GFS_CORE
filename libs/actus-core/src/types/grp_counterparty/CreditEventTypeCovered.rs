...
impl TermDescriptionTrait for CreditEventTypeCovered {
    ...
    fn get_description(&self) -> &str {
        "The cont_type of credit events covered e.g. in credit enhancement or credit default swap contracts. Only the defined credit event types may trigger the protection."
    }
}
