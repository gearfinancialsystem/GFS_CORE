...
use lib_actus_states_space::states_space::StatesSpace::{BoundaryLeg1ActiveFlag, BoundaryLeg2ActiveFlag, BoundaryMonitoringFlag, StatesSpace};
...
impl ResultSet {
    ...
    pub fn set_result_set(&mut self, curr_states: &StatesSpace,  source_ce: &ContractEvent<IsoDatetime, IsoDatetime>) {
