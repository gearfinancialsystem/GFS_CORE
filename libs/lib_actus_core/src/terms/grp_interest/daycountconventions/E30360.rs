...
mod tests {
    ...
    fn test_daycount_thirty_e_three_sixty_1() {
        ...
        let result = 28.0;
        assert_eq!(result, E30360.day_count(start1, end1) as f64);
    }
    ...
    fn test_daycount_thirty_e_three_sixty_2() {
        ...
        let result = 28.0;
        assert_eq!(result, E30360.day_count(start2, end2) as f64);
    }
    ...
    fn test_daycount_thirty_e_three_sixty_3() {
        ...
        let result = 5.0;
        assert_eq!(result, E30360.day_count(start3, end3) as f64);
    }
    ...
    fn test_daycount_thirty_e_three_sixty_4() {
        ...
        let result = 14.0;
        assert_eq!(result, E30360.day_count(start4, end4) as f64);
    }
